...
for key,vlaues in dict1.items():
    print('{0:>8s} : {1:<5s} | {2:>8s} : {3:<12s} | {4:>8s} : {5:<5s} | {6:>8s} : {7:<12s} | {8:>8s} : {9:<5s} | {10:>5s} : {11:<12s}'.format\
    ('protocol',key[0],'src_ip',key[1],'src_p',key[2],'dst_ip',key[3],'dst_p',key[4],'bytes',vlaues[-1]))
    print('='*120)
