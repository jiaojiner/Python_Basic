...
line1 = 'department:{0:<10}   depart_m:{1:<10}   fees:{2:<10.2f}'.format('department1','depart1_m',course_fees_depart1)
line2 = 'department:{0:<10}   depart_m:{1:<10}   fees:{2:<10.2f}'.format('department2','depart2_m',course_fees_depart2)
